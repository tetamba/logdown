...
log_file = "nominal_calculate_logdown_v1.1.1.1_" + str_today + ".log"
logging.basicConfig(filename=log_file,
                    format='%(asctime)s %(message)s',
                    filemode='a')

# Running app
print("-- Calculate logdown downtime from database recon v1.1.1.1 --")                    
...
logger.info("Running script v1.1.1.1")
